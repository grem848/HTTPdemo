...
import servlets.MySessionAttributeListener;
    ...
    private void makeHtmlPage(String name, String secret, HttpServletResponse response) throws IOException
    {
        ...
        try (PrintWriter out = response.getWriter())
        {
            ...
            out.println("<br>"
                    + "<h3>Observations</h3>"
                    + "<br>"
                    + "Because we use session cookies, the information and session is kept"
                    + "<br>"
                    + "and because we have a session, only we can see what we wrote and our secret."
                    + "<br>"
                    + "Only if someone steals our session id they can see our secret");
            out.println("        <br>\n"
